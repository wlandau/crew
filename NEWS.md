...
* Deprecate the `processes` field of controllers. Asynchronous worker launch/termination operations are no longer supported (#237). Job arrays will be a better solution.
