...
daemons_error <- function(daemons, name) {
  ...
  lines_common <- c(
    ...
    "R process. To confirm this is an issue, you can try again",
    "with memory logging: supply a log file path to the",
    "log_resources argument of the controller.",
    "For details, see",
    "https://wlandau.github.io/crew/articles/introduction.html#resources.",
