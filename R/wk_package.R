#' workerui: abstract interface specification for semi-persistent
#'   high-performance computing workers
#' @docType package
#' @name workerui-package
#' @description The user interface in `workerui` is an abstraction for
#'   high-performance computing technologies.
#'   Like the `future` R package,
#'   `workerui` provides a backend-agnostic standard.
#'   But unlike `future`, `workerui` prioritizes centralized scheduling,
...
#'   like `future`. Then, `workerui` supplies an `R6` subclass to
