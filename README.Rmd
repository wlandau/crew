...
For the best performance and reliability, we recommend you install [`mirai`](https://github.com/shikokuchuo/mirai) version 0.8.1.9003 or above and [`nanonext`](https://github.com/shikokuchuo/nanonext) version 0.8.0.9001 or above. In case the CRAN releases are older, you can install the most recent versions from [r-universe](https://r-universe.dev/):
