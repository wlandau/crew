...
You can retieve the results of a completed task, if available, with `pop()`. Like `push()`, `pop()` also tries to launch workers for pending tasks that need them. The return value is `NULL` if no new tasks are complete.
