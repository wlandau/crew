...
* [Gábor Csárdi](https://github.com/gaborcsardi/). Gábor created the [`callr`](https://github.com/r-lib/callr) R package, and he wrote about [how to build a task queue](https://www.tidyverse.org/blog/2019/09/callr-task-q/) using `callr::r_session` workers. His work heavily influenced the design of `crew`.
