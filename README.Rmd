...
Please see <https://wlandau.github.io/crew/> for documentation, including a full function reference and usage tutorial vignettes. It is recommended to begin with the `mirai` `callr` vignette.
...
* [Charlie Gao](https://github.com/shikokuchuo) for his work on [`mirai`](https://github.com/shikokuchuo/mirai) and for accommodating the feature requests that made `crew` possible.
