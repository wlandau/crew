...
Create an `R6` object to submit tasks and launch workers on local
processes.
...
Other plugin_local:
[`crew_class_launcher_local`](https://wlandau.github.io/crew/reference/crew_class_launcher_local.md),
