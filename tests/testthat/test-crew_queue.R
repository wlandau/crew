...
crew_test("queue$push()", {
  q <- crew_queue(step = 100L)
  q$push(c("a", "b"))
  expect_equal(q$size(), 2L)
  q$push(c("x", "y"))
  expect_equal(q$size(), 4L)
