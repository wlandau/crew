...
crew_test("crew_assert_nonnegative_dbl_scalar()", {
  expect_silent(crew_assert_nonnegative_dbl_scalar(1))
  expect_silent(crew_assert_nonnegative_dbl_scalar(0))
  expect_error(
    crew_assert_nonnegative_dbl_scalar(-1),
    class = "crew_error"
  )
  expect_error(
    crew_assert_nonnegative_dbl_scalar(numeric(0)),
    class = "crew_error"
  )
  expect_error(
    crew_assert_nonnegative_dbl_scalar(NULL),
    class = "crew_error"
  )
  expect_error(
    crew_assert_nonnegative_dbl_scalar("a"),
    class = "crew_error"
  )
  expect_error(
    crew_assert_nonnegative_dbl_scalar(seq_len(2)),
    class = "crew_error"
  )
})

crew_test("crew_assert_lgl_scalar()", {
...
crew_test("crew_assert_named()", {
  expect_silent(crew_assert_named(list(x = 1)))
  expect_error(crew_assert_named(list(1)), class = "crew_error")
  expect_error(crew_assert_named(list(a = 1, a = 2)), class = "crew_error")
  expect_error(crew_assert_named(list(a = 1, 2)), class = "crew_error")
})
