...
#> [1] "crew::crew_worker(settings = list(url = \"ws://127.0.0.1:5000/3/aa9c59ea\", maxtasks = Inf, idletime = Inf, walltime = Inf, timerstart = 0L, exitlinger = 1000, cleanup = FALSE, asyncdial = FALSE), launcher = \"my_launcher\", worker = 3L, instance = \"aa9c59ea\")"
```
...
#> # A tibble: 2 × 5
#>   worker_connected worker_busy worker_launches worker_instances worker_socket                      
#>   <lgl>            <lgl>                 <int>            <int> <chr>                              
#> 1 TRUE             FALSE                     1                1 ws://10.0.0.9:49612/1/bbc1a2241dd8…
#> 2 FALSE            FALSE                     0                0 ws://10.0.0.9:49612/2/c488c874a07e…
```
