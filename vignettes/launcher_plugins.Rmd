...
* `name`: the name of the launcher. Each worker instance launched with the launcher will receive the same `name` argument in `launch_worker()`.
* `token`: a text string that uniquely identifies every newly launched worker instance. Arguments `name` and `token` are useful for creating informative worker names.
