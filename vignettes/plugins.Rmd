...
This mechanism is similar to [retryable options in `crew.cluster`](https://wlandau.github.io/crew.cluster/reference/crew_options_slurm.html#retryable-options) and [in `crew.aws.batch`](https://wlandau.github.io/crew.aws.batch/reference/crew_options_aws_batch.html#retryable-options).
