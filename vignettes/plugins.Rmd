...
<span style="color: blue">**The launcher plugin framework aims to extend `crew` to modern platforms and services like [AWS Batch](https://aws.amazon.com/batch/), Google Cloud Run, [Kubernetes](https://kubernetes.io/), and beyond. At the time of writing, plugins for cloud computing do not yet exist. So if you know how to use these services and connect them with R, please consider contributing a package with plugins of your own. The maintainer of `crew` would love to work with you!**</span>
