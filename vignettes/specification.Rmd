...
* Its name.
* A data store to send and receive worker data.
...
* Paths to directories and subdirectories.
* Methods to read, write, check the existence of, and delete worker files.

A store creates and manages one file per active worker. There may be other files such as local temporary files.
