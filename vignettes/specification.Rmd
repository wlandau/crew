...
A `worker` object encapsulates a worker: a local process, cluster process, or cloud process that accepts and runs work that the crew dispatches. Required fields:
...
Worker that runs in a `callr::r_bg()` process.
